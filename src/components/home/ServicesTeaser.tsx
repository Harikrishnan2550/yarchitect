        ...
        >
          {services.map((service, idx) => (
            <motion.div 
              key={idx} 
              variants={fadeUp}
              className="group relative flex flex-col bg-white p-10 md:p-12 lg:p-14 rounded-xl shadow-[0_10px_40px_rgba(15,37,23,0.03)] hover:shadow-[0_30px_70px_rgba(15,37,23,0.08)] transition-all duration-700 overflow-hidden min-h-[420px] justify-between border border-forest/5"
            >
