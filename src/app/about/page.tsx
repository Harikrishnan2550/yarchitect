...
// ─── BULLETPROOF ANIMATION VARIANTS ───────────────────────────────────
const fadeUp = {
...
// Safe image reveal (Clip-path removed for mobile browser safety)
...
const AbstractFluidShape = ({ className }: { className?: string }) => (
  <div className={`absolute pointer-events-none opacity-[0.03] blur-[60px] md:blur-[80px] ${className}`}>
    <div className="w-[300px] md:w-[600px] h-[300px] md:h-[600px] rounded-full bg-forest mix-blend-multiply absolute top-0 left-0 animate-pulse" style={{ animationDuration: '8s' }} />
    <div className="w-[250px] md:w-[500px] h-[250px] md:h-[500px] rounded-full bg-sage mix-blend-multiply absolute top-20 left-20 md:top-32 md:left-32 animate-pulse" style={{ animationDuration: '12s', animationDelay: '2s' }} />
  </div>
);
...
const AbstractGeometry = ({ className }: { className?: string }) => (
  <svg className={`absolute pointer-events-none opacity-[0.02] ${className}`} viewBox="0 0 1000 1000" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M0 1000L1000 0H500L0 500V1000Z" fill="currentColor" className="text-forest" />
    <path d="M1000 1000L0 0H500L1000 500V1000Z" fill="currentColor" className="text-sage" />
  </svg>
);

// ─── RESPONSIVE MAGNETIC COMPONENT ───────────────────────────────────
...
export default function AboutPage() {
  ...
  const slowParallax = useTransform(smoothParallaxProgress, [0, 1], ["0%", "10%"]); // Safer positive parallax 
  ...
  return (
    <main className="min-h-screen bg-cream relative overflow-hidden text-forest selection:bg-sage selection:text-white" ref={containerRef}>
      <motion.div className="fixed top-0 left-0 right-0 h-[3px] bg-sage origin-left z-[100]" style={{ scaleX }} />
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-[8%] relative z-10">
          ...
          <div className="w-full relative z-10 flex flex-col gap-6 md:gap-16">
            <motion.div variants={staggerContainer} initial="hidden" animate="visible">
              <motion.div variants={fadeUp} className="flex items-center gap-3 mb-4 md:mb-10">
                ...
                <p className="font-sans text-forest/50 tracking-[0.3em] text-[9px] md:text-xs uppercase font-bold">
                  Studio Manifesto
                </p>
              </motion.div>
              ...
              <div className="flex flex-col gap-1 md:gap-2">
                ...
                <div className="md:pl-16">
                  <AnimatedTitle text="Nature & Time." className="font-serif text-[14vw] md:text-[100px] lg:text-[130px] font-light leading-[0.9] tracking-tighter text-sage italic" />
                </div>
              </div>
            </motion.div>
            
            <motion.div initial="hidden" animate="visible" variants={fadeUp} className="w-full md:max-w-[420px] md:self-end mt-2 md:mt-4">
              <p className="font-sans font-light text-[14px] md:text-[16px] leading-[1.6] md:leading-[1.8] text-forest/70 border-l border-sage/30 pl-4 md:pl-5">
        ...
        <section className="py-12 md:py-32 relative">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={staggerContainer} className="max-w-[1000px] mx-auto text-center relative z-10">
            <AnimatedTitle text='"Extracting the architecture that slumbers within the earth."' className="justify-center font-serif text-[9.5vw] md:text-[56px] lg:text-[64px] font-light leading-[1.1] tracking-tight text-forest" />
          </motion.div>
        </section>

        {/* ── 3. STAGGERED EDITORIAL FLOW (Image First on Mobile) ── */}
        <section className="flex flex-col gap-12 md:gap-32 border-t border-forest/10 pt-12 md:pt-24 relative">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-6 lg:gap-20 relative z-10">
            {/* Image is natively above text in standard flex-col */}
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={safeImageReveal} className="w-full lg:w-1/2 h-[300px] md:h-[65vh] overflow-hidden relative bg-forest/5 rounded-2xl md:rounded-3xl shrink-0">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="w-full lg:w-1/2 flex flex-col justify-center">
              <motion.span variants={fadeUp} className="font-sans text-[9px] md:text-[10px] tracking-[0.3em] text-sage font-bold uppercase mb-3 md:mb-6 flex items-center gap-4">
                01 <span className="w-6 h-[1px] bg-sage" /> Philosophy
              </motion.span>
              <motion.h3 variants={fadeUp} className="font-serif text-[11vw] md:text-[56px] leading-[1] text-forest mb-4 md:mb-8 tracking-tight">Material Honesty</motion.h3>
              <motion.p variants={fadeUp} className="font-sans font-light text-[14px] md:text-[16px] leading-[1.6] md:leading-[1.8] text-forest/70 mb-3 md:mb-6">
              ...
              <motion.p variants={fadeUp} className="font-sans font-light text-[14px] md:text-[16px] leading-[1.6] md:leading-[1.8] text-forest/70">
                We firmly believe that a structure should age gracefully. By utilising raw exposed laterite, red oxide floors, and unvarnished natural timber, we allow our buildings to develop a rich patina.
              </motion.p>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row-reverse items-start lg:items-center gap-6 lg:gap-20 relative z-10">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={safeImageReveal} className="w-full lg:w-5/12 h-[300px] md:h-[60vh] overflow-hidden relative bg-forest/5 rounded-2xl md:rounded-3xl shrink-0">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="w-full lg:w-7/12 flex flex-col justify-center lg:ml-auto">
              <motion.span variants={fadeUp} className="font-sans text-[9px] md:text-[10px] tracking-[0.3em] text-sage font-bold uppercase mb-3 md:mb-6 flex items-center gap-4">
                02 <span className="w-6 h-[1px] bg-sage" /> Approach
              </motion.span>
              <motion.h3 variants={fadeUp} className="font-serif text-[11vw] md:text-[56px] leading-[1] text-forest mb-4 md:mb-8 tracking-tight">Climatic Synergy</motion.h3>
              <motion.p variants={fadeUp} className="font-sans font-light text-[14px] md:text-[16px] leading-[1.6] md:leading-[1.8] text-forest/70">
                Our master planners and interior designers strictly adhere to regional climatic responses. By harnessing the monsoon breeze and filtering the equatorial sun, we create highly efficient sanctuaries.
              </motion.p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-32 border-t border-forest/10 mt-16 md:mt-24 relative">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="flex flex-col md:flex-row md:items-end justify-between mb-8 md:mb-20 gap-4 md:gap-6">
            <div className="flex flex-col">
              <motion.span variants={fadeUp} className="font-sans text-[9px] md:text-[10px] tracking-[0.3em] uppercase text-sage font-bold mb-3 md:mb-4 flex items-center gap-3">
                <span className="w-1.5 h-1.5 bg-sage rotate-45" /> Why Commission Us
              </motion.span>
              <motion.h2 variants={fadeUp} className="font-serif text-[10vw] md:text-6xl text-forest tracking-tight leading-[1.1]">The Value of <br className="hidden md:block"/>Architecture.</motion.h2>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 relative z-10">
            {[
              ...
              <motion.div key={idx} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="flex flex-col group relative">
                <motion.div variants={drawLine} className="w-full h-[1px] bg-forest/10 mb-4 md:mb-5 group-hover:bg-sage transition-colors duration-500 origin-left" />
                <motion.span variants={fadeUp} className="font-serif text-xl md:text-2xl text-sage italic mb-1 md:mb-2">0{idx + 1}</motion.span>
                <motion.h4 variants={fadeUp} className="font-serif text-[6.5vw] md:text-3xl text-forest mb-2 md:mb-3 tracking-tight">{item.title}</motion.h4>
                <motion.p variants={fadeUp} className="font-sans font-light text-[13px] md:text-[14px] leading-[1.6] md:leading-[1.8] text-forest/70">{item.desc}</motion.p>
              </motion.div>
            ))}
          </div>
        </section>
      ...
      <section className="relative py-20 md:py-40 text-center z-10 bg-forest text-cream overflow-hidden md:rounded-t-[3rem]">
        <AbstractGeometry className="top-0 left-0 w-full h-full opacity-10 text-white" />
         ...
         <Magnetic>
           <Link href="/contact" className="group inline-flex flex-col items-center justify-center w-full px-6 relative z-10">
              <motion.span initial="hidden" whileInView="visible" variants={fadeUp} className="font-sans text-[9px] md:text-[10px] tracking-[0.4em] uppercase text-sage mb-4 md:mb-6 font-bold flex items-center gap-4">
                <span className="w-6 md:w-8 h-[1px] bg-sage group-hover:w-16 transition-all duration-700 ease-out" />
                The Next Step
                <span className="w-6 md:w-8 h-[1px] bg-sage group-hover:w-16 transition-all duration-700 ease-out" />
              </motion.span>
              <div className="overflow-hidden">
                <motion.span initial="hidden" whileInView="visible" variants={maskReveal} className="font-serif text-[11vw] md:text-[100px] lg:text-[120px] font-light italic leading-none group-hover:text-sage transition-colors duration-700 ease-out tracking-tighter block">
                  Start your retreat ⟶
                </motion.span>
              </div>
           </Link>
